...
По умолчанию вход для сотрудников — только по табельному номеру без пароля,
пользователь создается автоматически при первом входе, если номер найден в таблице.
